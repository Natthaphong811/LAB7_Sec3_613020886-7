...
class MainActivity : AppCompatActivity() {
    ...
    fun studentData(){
        ...
        studentList.add(Student("629876543-2","Bob",20))
    }
    fun addStudent(view:View){
        ...
        mAlertDialog.btnAdd.setOnClickListener(){
            studentList.add(Student(mAlertDialog.edt_id.text.toString(), mAlertDialog.edt_name.text.toString(), mAlertDialog.edt_age.text.toString().toInt()))
